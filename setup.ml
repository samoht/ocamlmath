...
(* OASIS_START *)
(* DO NOT EDIT (digest: 09460b90ed78d1730c0433703a8be1b8) *)
(*
...
let setup_t =
  {
     ...
     doc =
       [
          ("math", OCamlbuildDocPlugin.doc_build "lib/");
          ("graphicmath", OCamlbuildDocPlugin.doc_build "lib/")
       ];
     ...
     clean_doc =
       [
          ("math", OCamlbuildDocPlugin.doc_clean "lib/");
          ("graphicmath", OCamlbuildDocPlugin.doc_clean "lib/")
       ];
     distclean = [];
     distclean_test = [];
     distclean_doc = [];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Draw"; "Widget"; "Analogic"; "Spec"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "math";
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\027ÄÁP.-Síqv*(â\"OM";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
